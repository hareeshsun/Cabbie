...
public class FirebaseNotification
{
   ...
   // static Dialog loadingDialog;
        ...
        JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.POST, URL,
                ...
                new Response.Listener<JSONObject>()
                {
                   ...
                   //         loadingDialog.dismiss();
                        //    notificationListener.notificationKey(notification);
                            test = notification;
    ...
    public  static String notificationRequest(final String notificationKey, ArrayList<String> registrationToken, final Context context)
    {
    /*Post data*/
        //   loadingDialog = new SpotsDialog(context,"Logging...");
        final String notkey;
